...
@CLIENTES_CADASTRO_INFO_TIPODEPAGAMENTO_VER @RELACIONAMENTO_SUPORTE_COMERCIAL_ANALISTA
...
@CLIENTES_CADASTRO_INFO_TIPODEPAGAMENTO_EDITAR  @RELACIONAMENTO_SUPORTE_COMERCIAL_ANALISTA
